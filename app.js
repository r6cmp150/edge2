...
// UNVERIFIED_HYPHEN_SYMBOLS moved to core/market-data.js (Phase 0 extraction).
...
// COMPANY_NAMES moved to core/edge-scoring.js (2026-09-05 extraction) -- loaded as a classic <script> before this file, see index.html.

// NEG_KEYWORDS moved to core/edge-scoring.js (2026-09-05 extraction) -- loaded as a classic <script> before this file, see index.html.

// HOLIDAYS moved to core/clock.js (Phase 0 extraction).
...
// DAY_NAMES/getPT/ptDateStr/isTradingDay/getMarketStatus/getCountdownToOpen/
// isAfternoonMode moved to core/clock.js (Phase 0 extraction).
...
// isPreMarketHours/isAfterHoursMode moved to core/clock.js (Phase 0 extraction).

// getLivePrice moved to core/market-data.js (Phase 0 extraction).
...
// MACRO_ADJUSTMENTS moved to core/edge-scoring.js (2026-09-05 extraction) -- loaded as a classic <script> before this file, see index.html.

// getMacroAdjustment moved to core/edge-scoring.js (2026-09-05 extraction) -- loaded as a classic <script> before this file, see index.html.
...
// classifyDuration moved to core/edge-scoring.js (2026-09-05 extraction) -- loaded as a classic <script> before this file, see index.html.

// calcEntryTargetStop moved to core/edge-scoring.js (2026-09-05 extraction) -- loaded as a classic <script> before this file, see index.html.

// calcRiskScore moved to core/edge-scoring.js (2026-09-05 extraction) -- loaded as a classic <script> before this file, see index.html.

// scoreStock moved to core/edge-scoring.js (2026-09-05 extraction) -- loaded as a classic <script> before this file, see index.html.
...
async function writeTradeToSupabase(pos, record, saleDate, salePrice, pnlDollar, pnlPct) {
  try {
    ...
    const { data, error } = await supabaseClient.from('trades_v2').insert([{
      ...
      signal_snapshot: pos.signalSnapshot ?? null,
      exit_rule_id: pos.exitRuleId ?? null,
      minutes_late: pos.minutesLate ?? null,
...
// isMarketHoursNow/businessDaysBetween moved to core/clock.js (Phase 0 extraction).
